    ...
    >
      ...
      {active !== null && (
        <motion.div
          ...
          // Changed from center alignment to left alignment
          className="absolute left-0 top-[calc(100%_+_0.3rem)]"
          onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave}
        >
          {active === item && (
            <div className="z-50 pointer-events-auto">
              {/* Invisible bridge to connect menu item and dropdown - adjusted for left alignment */}
              <div className="absolute -top-1 left-0 w-full h-1 bg-transparent pointer-events-auto" />
