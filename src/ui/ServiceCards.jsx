...
export const CardTitle = ({
  ...
  return (
    <h3
      className={twMerge("text-lg font-semibold text-gray-800 dark:text-white py-2", className)}>
      {children}
    </h3>
  );
};
...
export const CardSkeletonContainer = ({
  ...
  return (
    <div
      className={twMerge("h-[15rem] md:h-[20rem] rounded-xl z-40", className, showGradient &&
