...
const Footer = () => {
  const socialLinks = [
    { icon: Facebook, href: 'https://www.facebook.com/quanticsolutuion', label: 'Facebook' },
    { icon: Instagram, href: 'https://www.instagram.com/quanticsols/', label: 'Instagram' },
    { icon: Linkedin, href: 'https://www.linkedin.com/company/quanticsols/posts/?feedView=all', label: 'LinkedIn' },
    { icon: Mail, href: 'mailto:contact@quanticsols.com', label: 'Email' }
  ];
